...
import (
	"github.com/sanazmovahed/bookstore_oauth-go/oauth/errors"
...
func AuthenticateRequest(request *http.Request) *errors.RestErr {
	...
	accessTokenId := strings.TrimSpace(request.URL.Query().Get(paramAccessToken)) // http://api.bookstore.com/resource?access_token=abc123
	if accessTokenId == "" {
		return nil
	}
